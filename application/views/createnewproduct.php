                                 ...
                                 <div class="">
                                    <div class="card-body">
                                       <div class="mb-3">
                                          ...
                                          <input class="form-control" type="text" name="product_id" aria-describedby="emailHelp" placeholder="Product ID">
                                       </div>
                                       <div class="mb-3">
                                 ...
                                 <div class="">
                                    <div class="card-body">
                                       <div class="mb-3">
                                          ...
                                          <input class="form-control" type="text" name="product_created_date_time" aria-describedby="emailHelp" placeholder="Category Date Time">
                                       </div>
                                       <div class="mb-3">
