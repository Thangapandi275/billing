                           ...
                           <div class="card-body">
                              <div class="order-history table-responsive">
                                 <table class="table table-bordernone display" id="basic-1">
                                    ...
                                    <tbody>
                                       <tr>
                                          <td><a href="product-page.html"><img class="img-fluid img-30" src="<?php echo base_url(); ?>//assets/images/product/1.png" alt="#"></a></td>
                                          <td>
                                       ...
                                       <tr>
                                          <td><a href="product-page.html"><img class="img-fluid img-30" src="<?php echo base_url(); ?>//assets/images/product/13.png" alt="#"></a></td>
                                          <td>
                                             <div class="product-name">
                                       ...
                                       <tr>
                                          <td><img class="img-fluid img-30" src="<?php echo base_url(); ?>//assets/images/product/4.png" alt="#"></td>
                                          <td>
                                             <div class="product-name">
                                                <a href="#">Man shoes</a>
                                                <div class="order-process"><span class="order-process-circle"></span>Processing</div>
                                       ...
                                       <tr>
                                          <td><a href="product-page.html"><img class="img-fluid img-30" src="<?php echo base_url(); ?>//assets/images/product/10.png" alt="#"></a></td>
                                          <td>
                                             <div class="product-name">
                                       ...
                                       <tr>
                                          <td><a href="product-page.html"><img class="img-fluid img-30" src="<?php echo base_url(); ?>//assets/images/product/12.png" alt="#"></a></td>
                                          <td>
                                             <div class="product-name">
                                       ...
                                       <tr>
                                          <td><a href="product-page.html"><img class="img-fluid img-30" src="<?php echo base_url(); ?>//assets/images/product/3.png" alt="#"></a></td>
                                          <td>
                                             <div class="product-name">
                                       ...
                                       <tr>
                                          <td><a href="product-page.html"><img class="img-fluid img-30" src="<?php echo base_url(); ?>//assets/images/product/2.png" alt="#"></a></td>
                                          <td>
                                             <div class="product-name">
                                       ...
                                       <tr>
                                          <td><a href="product-page.html"><img class="img-fluid img-30" src="<?php echo base_url(); ?>//assets/images/product/15.png" alt="#"></a></td>
                                          <td>
                                             <div class="product-name">
                                       ...
                                       <tr>
                                          <td><a href="product-page.html"><img class="img-fluid img-30" src="<?php echo base_url(); ?>//assets/images/product/14.png" alt="#"></a></td>
                                          <td>
                                             <div class="product-name">
                                                <a href="#">Watch</a>
                                                <div class="order-process"><span class="order-process-circle cancel-order"></span>Cancelled</div>
                                       ...
                                       <tr>
                                          <td><a href="product-page.html"><img class="img-fluid img-30" src="<?php echo base_url(); ?>//assets/images/product/11.png" alt="#"></a></td>
                                          <td>
                                             <div class="product-name">
                                                <a href="#">Slipper</a>
                                                <div class="order-process"><span class="order-process-circle cancel-order"></span>Cancelled</div>
